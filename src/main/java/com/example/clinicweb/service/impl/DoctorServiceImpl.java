...
public class DoctorServiceImpl implements DoctorService {
    ...
    public Page<Doctor> findByFullNameContainingIgnoreCase(String keyword, Pageable pageable){ return doctorRepository.findByFullNameContainingIgnoreCase(keyword, pageable);}
